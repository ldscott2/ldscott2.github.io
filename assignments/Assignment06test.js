...
var loans = [
 ...
 let saveForm = () => {
   localStorage.setItem(`Assignment06.html`, JSON.stringify(loans));
 }

 let loadForm = () => {
  if(localStorage.getItem(`Assignment06.html`) != null){
     loans = JSON.parse(localStorage.getItem(`Assignment06.html`));
     updateForm();
  } else {
